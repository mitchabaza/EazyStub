...
namespace EasyStub.Test.Server
{
    public class RequestMatcherFixture : FixtureBase<RequestMatcher>
    {
        ...
        public void Match_ShouldReturnNull_WhenAllAttributesRequireExactMatchAndThereAreNone()
        {
            ...
            var requestRegistration = Fixture.Create<RequestRegistrationModel>();
        ...
        {
            var model = Fixture.Create<HttpRequestModel>();
            var requestRegistration = new RequestRegistrationModel {LocalPath = model.LocalPath};
        ...
        {
            var model = Fixture.Create<HttpRequestModel>();
            var requestRegistration = new RequestRegistrationModel { LocalPath = model.LocalPath + "1" };
